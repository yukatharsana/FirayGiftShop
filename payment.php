            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="inputbox">
                        ...
                        <img src="Images/card_img.png" alt="credit card">
                    </div>
                    ...
                    <div class="inputbox">
                        ...
                        <input type="text" placeholder="MS K.YATHUSNEE" required>
                    </div>
                    ...
                    <div class="inputbox">
                        ...
                        <input type="text" placeholder="077 000 0000" pattern="[0-9]{3} [0-9]{3} [0-9]{4}" required>
                    </div>
